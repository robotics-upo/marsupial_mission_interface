...
bool bisectionCat::configBisection(double _l, double _x1, double _y1, double _z1, double _x2, double _y2, double _z2)
{
    resetVariables();
    ...
    if (L > distance_3d)
        ...
        printf("Warning: Input Length minor that necesary distance between point to apply bisection method ugv[%f %f %f] uav[%f %f %f]\n",_x1, _y1, _z1, _x2, _y2, _z2);
        L_minor_than_D = true;
    }
...
void bisectionCat::checkStateCatenary(double _x1, double _y1, double _z1, double _x2, double _y2, double _z2)
{
...
void bisectionCat::getPointCatenary3D(vector<geometry_msgs::Point> &v_p_, bool dist_interpolation_)
{
...
void bisectionCat::getPointCatenaryStraight(std::vector<geometry_msgs::Point> &v_p_)
{
...
double bisectionCat::resolveBisection(double a1_, double b1_, int mode_) 
{
...
double bisectionCat::functionBisection(double xr_aux, int mode_)
{
    double yr_aux;
...
bool bisectionCat::lookingSignChanging (double a2, double b2, int mode_)
{
...
inline void bisectionCat::getNumberPointsCatenary(double _length){num_point_catenary = round( (double)num_point_per_unit_length * _length);}  

bool bisectionCat::setNumPointsPerUnitLength(int n)
{
    if(n>0)
    {
...
void bisectionCat::setResolution(int res_)
{
  resolution = res_;
  div_res = 1.0/resolution;
}

inline void bisectionCat::setFactorBisection(double _fa,double _fb){factor_bisection_a = _fa; factor_bisection_b = _fb;}

void bisectionCat::getMinPointZCat(geometry_msgs::Point &p_, int &n_)
{
...
void bisectionCat::getMidPointCat(geometry_msgs::Point &p_, int &n_)
{
...
void bisectionCat::resetVariables()
{
    L = 0.0;
...
void bisectionCat::getStatusCollisionCat(std::vector<double> &dist_obst_cat_, std::vector<int> &pos_cat_in_coll_, std::vector<int> &cat_between_obs_, int &first_coll_, int &last_coll_)
{
...
void bisectionCat::markerPoints(visualization_msgs::MarkerArray _marker, std::vector<geometry_msgs::Point> _vector, ros::Publisher c_m_pub_)
{
...
void bisectionCat::clearMarkers(visualization_msgs::MarkerArray _marker, int _s, ros::Publisher c_m_pub_)
{
